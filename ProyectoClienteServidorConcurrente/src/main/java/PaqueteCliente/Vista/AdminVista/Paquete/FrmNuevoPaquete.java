...
public class FrmNuevoPaquete extends JDialog {
    ...
    private JTextField txtDescripcion, txtRemitente, txtDestinatario, txtDireccion, txtIdPaquete, txtFechaCreacion,
            txtPeso;
    ...
    public FrmNuevoPaquete(PanelPaquete parentFrame, Paquete paqueteEncontrado) {
        super((Frame) javax.swing.SwingUtilities.getWindowAncestor(parentFrame), "Editar Paquete", true);
        setSize(400, 520);
        ...
        this.paqueteExistente = paqueteEncontrado; // Se guarda el paquete existente
    ...
    private void configurarEventos() {
        ...
        btnGuardar.addActionListener(e -> {
            ...
            if (pesoTexto.isEmpty() || pesoTexto.equals(placeholder)) {
                JOptionPane.showMessageDialog(this, "Debe indicar un peso válido para el paquete.", "Validación",
            ...
            try {
                ...
                if (pesoFinal.compareTo(BigDecimal.ZERO) <= 0) {
                    JOptionPane.showMessageDialog(this, "El peso debe ser una cantidad mayor a 0.", "Validación",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }
            } catch (NumberFormatException ex) {
                JOptionPane.showMessageDialog(this, "Por favor, ingrese un número válido para el peso (Ejemplo: 5.25).",
