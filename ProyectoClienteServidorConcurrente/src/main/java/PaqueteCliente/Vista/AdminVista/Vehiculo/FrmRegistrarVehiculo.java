...
public class FrmRegistrarVehiculo extends JDialog {
    ...
    public FrmRegistrarVehiculo(PanelVehiculo parentFrame, Vehiculo vehiculoEncontrado) {
        super((Frame) javax.swing.SwingUtilities.getWindowAncestor(parentFrame), "Editar Vehiculo", true);
        setSize(450, 600);
        ...
        this.vehiculoExistente = vehiculoEncontrado; // Se guarda el vehiculo existente
    ...
    private void initComponents() {
        ...
        cbMarca = new JComboBox<>(new String[] { "- Seleccione -", "Chevrolet", "Volkswagen", "Hyundai", "Fiat",
                "Renault", "Kia", "Mazda", "Peugeot", "Mitsubishi", "Toyota", "Mercedez-Beans", "Suzuki", "Iveco",
                "Freightliner", "Volvo", "Ford", "Hino", "Honda", "Nissan" });
        cbMarca.setBounds(180, 220, 170, 30);
        add(cbMarca);

        addLabel("Modelo de vehiculo", 50, 270);
        cbModelo = new JComboBox<>(new String[] {
                "- Seleccione -", "1990", "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999",
                "2000", "2001", "2002",
        ...
        btnGuardar.addActionListener(e -> {
            ...
            if (res) {
                ...
                JOptionPane.showMessageDialog(this,
                        "Error de red: No se pudo conectar con el servidor o persistir los datos.", "Error",
    ...
    public void listaRamdon() {
        ...
        for (int i = 0; i <= 9999; i++) {
            // % - inicia la regla, 0 - indica el caracter de relleno, 4 - longitud total, d
            // - argumento de numero entero (decimal)
