...
public class FrmNuevoUsuario extends JDialog {
    ...
    public FrmNuevoUsuario(Frame parent, Usuarios usuario) {
        this(parent);
    ...
    private void initComponents() {
        ...
        // El editor visual es en realidad un JTextField encubierto, lo recuperamos con un casteo seguro
    ...
    private void configurarEventos() {
        ...
        btnGuardar.addActionListener(e -> {
            ...
            // Se blinda la opcion de ingreso de fecha vacia, si al usuario se le olvida finalizar un dato
            ...
            if (nombre.isEmpty() || apellido.isEmpty() || dni.isEmpty() || email.isEmpty() || telefono.isEmpty() || pass.isEmpty() || rolId == 0){
            ...
            if (usuarioExistente == null) {
                //Modo crear
                res = adminControl.registrarNuevoUsuario(nombre, apellido, fechaNacimientoDate, dni, email, telefono, pass, rolId);
                ...
                usuarioExistente.setPassword(pass);
        ...
        btnVerPass.addActionListener(e -> {
            ...
            //Le devolvemos el foco al cuadro de texto para que el usuario pueda seguir escribiendo
